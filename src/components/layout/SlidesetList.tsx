		...
		<>
			<div className="space-y-6 mb-8 md:mb-10">
				{slideSets.map((slideSet) => (
					<Link className="flex items-center justify-between" href={isAdmin ? routes.admin.slideDecks.single(slideSet.id) : routes.slideDecks.single(slideSet.id)} key={slideSet.id}>
						<div>
